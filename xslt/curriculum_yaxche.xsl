    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                ...
                <a target="_blank"><xsl:attribute name="href">../imagenes/<xsl:value-of select="curriculum/informacion_personal/imagen"/></xsl:attribute><img alt="imagen yaxche" class="imagen-derecha">
